...
set CLASSPATH=%APP_HOME%\lib\runtime-main.jar;%APP_HOME%\lib\runtime-tenant.jar;%APP_HOME%\lib\runtime-bootstrap-1.0.0.jar;%APP_HOME%\lib\runtime-event.jar;%APP_HOME%\lib\runtime-module.jar;%APP_HOME%\lib\compiler-packaging.jar;%APP_HOME%\lib\compiler-generator.jar;%APP_HOME%\lib\runtime-config.jar;%APP_HOME%\lib\runtime-core-1.0.0.jar;%APP_HOME%\lib\compiler-contracts.jar;%APP_HOME%\lib\compiler-workflow.jar;%APP_HOME%\lib\compiler-projection.jar;%APP_HOME%\lib\compiler-blueprint.jar;%APP_HOME%\lib\compiler-audit.jar;%APP_HOME%\lib\compiler-dsl.jar;%APP_HOME%\lib\compiler-core.jar;%APP_HOME%\lib\jakarta.inject-api-2.0.1.jar;%APP_HOME%\lib\guice-5.1.0.jar;%APP_HOME%\lib\jackson-module-jakarta-xmlbind-annotations-2.17.2.jar;%APP_HOME%\lib\jackson-annotations-2.17.2.jar;%APP_HOME%\lib\jackson-core-2.17.2.jar;%APP_HOME%\lib\jackson-datatype-jsr310-2.17.2.jar;%APP_HOME%\lib\jackson-databind-2.17.2.jar;%APP_HOME%\lib\javax.inject-1.jar;%APP_HOME%\lib\aopalliance-1.0.jar;%APP_HOME%\lib\guava-30.1-jre.jar;%APP_HOME%\lib\slf4j-simple-2.0.17.jar;%APP_HOME%\lib\slf4j-api-2.0.17.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.5.0.jar;%APP_HOME%\lib\error_prone_annotations-2.3.4.jar;%APP_HOME%\lib\j2objc-annotations-1.3.jar;%APP_HOME%\lib\jakarta.xml.bind-api-3.0.1.jar;%APP_HOME%\lib\jakarta.activation-api-2.1.0.jar;%APP_HOME%\lib\jakarta.activation-2.0.1.jar
