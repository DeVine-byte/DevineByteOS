...
@rem ##########################################################################
@rem
@rem  dbos-compiler startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and DBOS_COMPILER_OPTS to pass JVM options to this script.
...
@rem Execute dbos-compiler
@rem endlocal doesn't take effect until after the line is parsed and variables are expanded
@rem which allows us to clear the local environment before executing the java command
endlocal & "%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DBOS_COMPILER_OPTS%  -classpath "%CLASSPATH%" io.devinebyte.compiler.cli.CompilerCli %* & call :exitWithErrorLevel
